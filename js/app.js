(() => {
    ...
    class DynamicAdapt {
        ...
        init() {
            ...
            this.mediaQueries = this.objects.map((({breakpoint}) => `(${this.type}-width: ${this.toEm(breakpoint)}),${breakpoint}`)).filter(((item, index, self) => self.indexOf(item) === index));
    ...
    if (document.querySelector(".promo__slider")) new Swiper(".promo__slider", {
        ...
        autoHeight: true,
        navigation: {
            prevEl: ".promo-slider-controll__prev",
            nextEl: ".promo-slider-controll__next"
        },
        pagination: {
            el: ".promo-slider-controll__pagination"
        }
    });
    if (document.querySelector(".tea-blends__slider")) new Swiper(".tea-blends__slider", {
        modules: [ Navigation ],
        spaceBetween: 20,
        slidesPerView: 1,
        navigation: {
            prevEl: ".tea-blends-navigation__prev",
            nextEl: ".tea-blends-navigation__next"
        },
        breakpoints: {
            400: {
                slidesPerView: 2,
    ...
    const bodyLockToggle = () => {
        if (!document.documentElement.classList.contains("lock")) document.documentElement.classList.add("lock"); else document.documentElement.classList.remove("lock");
    };
    function menuInit() {
    ...
    let goToBlock = (targetBlock, speed = 800, offsetTop = 0) => {
